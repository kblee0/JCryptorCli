package com.home.jcryptor.encryptor;
...
public abstract class Encryptor {
    ...
    public static String readOpenSSHPublicKeyFile(String sshPubFilePath) throws Exception {
        return readOpenSSHPublicKey(Files.lines(Paths.get(sshPubFilePath), StandardCharsets.UTF_8).findFirst().orElse("").trim());
    }

    /**
     * Read an OpenSSH PublicKey from a stream.
     *
     * @param opensshPublicKey
     *            bytes to read.
     * @return a publicKey
    ...
    public static String readOpenSSHPublicKey(String opensshPublicKey)
        ...
        // format of decoded content is: <type><key-params>
